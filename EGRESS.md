...
written by hand, and the app offers nothing that produces one — so nothing here
shows a user reaching this at all. And this is one run, on one machine, against
one client version.
